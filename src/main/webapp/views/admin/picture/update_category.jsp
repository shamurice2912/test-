      ...
      <!-- ========== section start ========== -->
			...
			<div class="row">				
					<div class="col-lg-12">
						<div class="card">
							<div class="card-body">
								<form action="/ClothingStore01/updateCategory" method="post">
								...
								<c:if test="${requestScope.category != null }">
									...
									<div class="mt-3">
										...
										<input type="number" name="category_id" value="${category.category_id}" readonly="readonly" class="form-control" ></input>
									</div>
									<div class="mt-3">
										<label>Tên sản phẩm</label>
										<input type="text" name="category_name" value="${category.category_name }" class="form-control" ></input>
									</div>
									<div class="mt-3">
										<label>Mô tả</label>
										<input type="text" name="parentCategory" value="${category.parentCategory }" class="form-control" ></input>
									</div>
									<div class="mt-3">
