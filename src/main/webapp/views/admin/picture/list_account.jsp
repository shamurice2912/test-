									...
									<tbody>
										<c:forEach var="acc" items="${requestScope.accounts }">
											<tr>
												...
												<td>${acc.role_code}</td>
												<td>
												<a href="/ClothingStore01/updateAccount?user_id=${acc.user_id}">Sửa</a>
												<a href="/ClothingStore01/deleteAccount?user_id=${acc.user_id}" onclick="deleteAccount('${acc.user_id}');">Xóa</a>
												</td>
											</tr>
										</c:forEach>
									</tbody>
