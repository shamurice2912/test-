              ...
              <div class="auth-cover-wrapper bg-primary-100">
                <div class="auth-cover">
                  <div class="title text-center">
                    <h1 class="text-primary mb-10">Chào mừng bạn đã quay trở lại.</h1>
                    <p class="text-medium">
            ...
            <div class="col-lg-6">
              <div class="signin-wrapper">
                <div class="form-wrapper">
                  ...
                  <form action="/ClothingStore01/loginAdmin" method="post" >
                    <div class="row">
                      <div class="col-12">
                        <div class="input-style-1">
                          <label for="yourUsername">Tài khoản</label>
                          <input type="text" name="username" id="yourUsername" placeholder="Hãy nhập tài khoản" required/>
                        </div>
                      </div>
                      <!-- end col -->
                      <div class="col-12">
                        <div class="input-style-1">
                          <label for="yourpassword">Mật khẩu</label>
                          <input type="password" name="password" id="yourpassword" placeholder="Hãy nhập mật khẩu" required/>
                        </div>
                      </div>
                      <!-- end col -->
      ...
      <footer class="footer">
        <!-- Copyright -->
		    <div class="text-center p-3" style="background-color: rgba(0, 0, 0, 0.2); text-color: #E0E0E0">
		      © 2022 Copyright:
		      <a class="text-white" href="#">ITPLUS.com</a>
		    </div>
        <!-- Copyright -->
      </footer>
      <!-- ========== footer end =========== -->
