					...
					<div class="card">
						<div class="card-body">
							<form action="updateProduct" method="post">
								...
								<div class="mt-3">
									<label>Mã brand</label>
									<input type="number" name="brand_id" value="${product.brandId}" class="form-control"/>
								</div>
								<div class="mt-3">
								...
								<div class="mt-3">
									<label>price_more</label>
									<input type="number" name="price_more" value="${product.priceMore}"  class="form-control"/>
								</div>
								<div class="mt-3">
								...
								<div class="mt-3">
									...
									<input type="file" name="file"  value="${product.image_url}" class="form-control"/>
